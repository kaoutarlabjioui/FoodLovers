...
@section('title','Gestion des ingredients')
@section('css')
<style>
...
<div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold">Gestion des Ingrédient</h1>
        <p class="text-gray-600">Gérez toutes les ingredients de la plateforme</p>
    </div>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">{{$ingredient->ingredient}}</div>
                            </div>
                        </div>
                    </td>
                    <!-- <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900 max-w-xs truncate"></div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex space-x-2 justify-end">
                           <a href="/admin/editingredient/{{$ingredient->id}}">
                                <button class="text-yellow-600 hover:text-yellow-800 edit-ingredient" >
                                    <i class="fas fa-edit"></i>
                                </button>
                            </a>

                            <form action="{{ route('adminingredient.destroy') }}" method="POST" class="text-red-600 hover:text-red-800 delete-category">
                                @csrf
                                @method('DELETE')
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700">
                    Affichage de <span class="font-medium">1</span> à <span class="font-medium">5</span> sur <span class="font-medium">12</span> ingredients
                </p>
            </div>
            <div>
...
<!-- Modale Ajouter/Modifier Catégorie -->
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" id="category-modal-title">
                            Ajouter nouveau ingredient
                        </h3>

                        <div class="mt-2">
                            <form action="/admin/ingredient/store" method="POST" class="w-full space-y-4">
                                @csrf

                                <div class="form-element">
                                    <label for="titre" class="block text-sm font-medium text-gray-700 mb-1">Ingredient</label>
                                    <input type="text" name="ingredient" required placeholder="Ingredient"
                                ...
                                <div class="form-element">
                                    <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Etat</label>
                                    <input type="text" name="etat" required placeholder="etat"
                                        class="w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary focus:border-primary" />
                                </div>
