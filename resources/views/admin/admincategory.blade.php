                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex space-x-2 justify-end">
                           <a href="/admin/editecategory/{{$category->id}}">
                                <button class="text-yellow-600 hover:text-yellow-800 edit-category" >
                                    <i class="fas fa-edit"></i>
                                </button>
                            </a>

                            <form action="{{ route('admincategory.destroy') }}" method="POST" class="text-red-600 hover:text-red-800 delete-category">
                                @csrf
                                @method('DELETE')
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700">
                    Affichage de <span class="font-medium">1</span> à <span class="font-medium">5</span> sur <span class="font-medium">12</span> catégories
                </p>
            </div>
            <div>
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div class="mt-2">
                            <form action="/admin/category/store" method="POST" class="w-full space-y-4">
                                @csrf
