...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
      <div>
        ...
        <p class="text-gray-600">Modifiez les informations de la catégorie</p>
      </div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
      <div class="p-6">
        <form id="edit-category-form" action="/admin/category/update"  method="POST"   class="space-y-6">
            @csrf
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" id="category-name" name="title" value="{{$category->title}}" class="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary">
            </div>
          ...
          <div>
            ...
            <input id="category-description" name="description" value="{{$category->description}}" class="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary">
          </div>



          <div class="flex items-center">
            <label for="category-status" class="block text-sm font-medium text-gray-700 mr-3">Statut</label>
            <div class="form-check form-switch">
              <input class="form-check-input" type="checkbox" id="category-status" name="status" checked>
              <label class="form-check-label ml-2" for="category-status">Actif</label>
            </div>
          </div>
